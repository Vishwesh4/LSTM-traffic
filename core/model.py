...
class Model():
	...
	def build_model(self, configs):
		...
		self.model.compile(loss=configs['model']['loss'], optimizer=configs['model']['optimizer'],metrics =['mae'])
		self.model.summary()
	...
	def train_generator(self, data_gen, epochs, batch_size, steps_per_epoch, save_dir):
		...
		callbacks = [
			ModelCheckpoint(filepath=str(save_fname), monitor='loss', save_best_only=True)
		]
